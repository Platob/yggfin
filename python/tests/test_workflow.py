...
def test_ulbridge_messages_flow_directly_through_the_fix_codec(
    ...
    # The bytes are a line's and so is the digest of them, and this row is an
    # event's: the row names the line it was read from and `logs.messages`
    # holds the text. That join resolves, one stored line per row.
