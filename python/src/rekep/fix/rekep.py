...
REKEP_FIELD_DECLARATIONS: tuple[tuple[str, str, str, str, str], ...] = (
    ...
    ("eventtype", "EventType", "int64", "Event Type", "Packed rekep event-kind code."),
    (
        "creaunix",
        "CreaUnix",
        "int64",
    ...
    ("vhash", "VHash", "int64", "Value Hash", "Clock-free XXH3-64 value digest."),
    ...
    ("pxunit", "PxUnit", "String", "Px Unit", "Unit in which `px` is expressed."),
    ("qtyunit", "QtyUnit", "String", "Qty Unit", "Unit in which `qty` is expressed."),
    (
        "notional",
        "Notional",
        "double",
