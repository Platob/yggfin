...
from rekep import Convertible, Field, FixMsg, TextFile, scalar  # noqa: E402
...
def sweep_fs(rows: int, days: int) -> None:
    ...
    def fresh(root: pathlib.Path, name: str, cached: bool) -> IcebergDataset:
        ...
        return catalog.dataset(
            "bench.logs", field=FixMsg.into_field(), table_properties=OPTIMISED
        ).create_with()
...
def daily(root: pathlib.Path) -> IcebergDataset:
    ...
    """
    field = FixMsg.into_field().into_dataclass("Daily").into_field()
