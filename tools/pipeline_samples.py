...
invented ones: one business chain of `data/capture/ulbridge.log` -- a
...
TASKS = (
    ("parse_messages", {"filesystem": "file:data/capture/ulbridge.log", **WINDOW}),
...
def rendered(held: dict[str, pyarrow.Table]) -> dict[str, str]:
    ...
    note = (
        f"<!-- Generated by tools/pipeline_samples.py from data/capture/ulbridge.log,"
